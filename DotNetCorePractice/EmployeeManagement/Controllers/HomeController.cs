    ...
    public class HomeController : Controller
    {
        ...
        private string ProcessUploadedFile(EmployeeCreateViewModel model)
        {
            ...
            if (model.Photo != null)
            {
                ...
                // Here we are using using block to properly dispose the fileStream
                // so that it will not hold the file further processing (where we delete the existing image)
                // otherwise we will get process busy error when we move from Create to Edit action immediately
