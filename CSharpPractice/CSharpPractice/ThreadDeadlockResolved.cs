...
{
    class ThreadDeadlockResolved
    {
        internal static void ThreadDeadlockResolvedMain()
        {
            ...
            public void Transfer()
            {
                ...
                lock (_lock1)
                {
                    ...
                    lock (_lock2)
                    {
                        ...
                        Console.WriteLine(Thread.CurrentThread.Name + " Transfered " + _amountToTransfer.ToString() + " from "
