...
namespace CSharpPractice
{
    class AnonymousMethods
    {
        public static void AnonymousMethodsMain()
        {
            ...
            // the need for Step 1, 2 and 3, here we don't have method name, only the body part is present
            // Here (Employee x) has been been passed as an argument to the delegate 
