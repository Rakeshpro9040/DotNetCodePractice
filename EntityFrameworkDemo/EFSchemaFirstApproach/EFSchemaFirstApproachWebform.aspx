<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EFSchemaFirstApproachWebform.aspx.cs" Inherits="EntityFrameworkDemo.EFSchemaFirstApproach.EFSchemaFirstApproachWebform" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="ID" DataSourceID="EntityDataSource1" DefaultMode="Insert" ForeColor="#333333" GridLines="None" Height="50px" OnPageIndexChanging="DetailsView1_PageIndexChanging" Width="125px" OnItemInserted="DetailsView1_ItemInserted">
            <AlternatingRowStyle BackColor="White" />
