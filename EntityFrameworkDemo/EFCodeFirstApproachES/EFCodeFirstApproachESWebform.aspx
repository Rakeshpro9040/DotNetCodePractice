<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EFCodeFirstApproachESWebform.aspx.cs" Inherits="EntityFrameworkDemo.EFCodeFirstApproachES.EFCodeFirstApproachESWebform" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataSourceID="ObjectDataSource1" ForeColor="#333333" GridLines="None" Height="50px" Width="125px" DefaultMode="Insert" OnItemInserted="DetailsView1_ItemInserted">
                <AlternatingRowStyle BackColor="White" />
            ...
            <br />
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EntityFrameworkDemo.EFCodeFirstApproachES.Employee" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployees" TypeName="EntityFrameworkDemo.EFCodeFirstApproachES.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
