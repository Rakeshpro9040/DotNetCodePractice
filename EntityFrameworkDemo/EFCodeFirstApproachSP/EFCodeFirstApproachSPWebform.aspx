<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EFCodeFirstApproachSPWebform.aspx.cs" Inherits="EntityFrameworkDemo.EFCodeFirstApproachSP.EFCodeFirstApproachWebform" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EntityFrameworkDemo.EFCodeFirstApproachSP.Employee" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployees" TypeName="EntityFrameworkDemo.EFCodeFirstApproachSP.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
    </form>
</body>
</html>
